...
extern tag_typedef_t tptag_tls_timeout;
EXPORT tag_typedef_t tptag_tls_timeout_ref = 
  REFTAG_TYPEDEF(tptag_tls_timeout);
...
extern tag_typedef_t tptag_capt;
EXPORT tag_typedef_t tptag_capt_ref = 
  REFTAG_TYPEDEF(tptag_capt);
